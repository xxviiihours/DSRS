...
{
    /// <inheritdoc />
    public partial class AdditionalTableForSocial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayerA = table.Column<Guid>(type: "TEXT", nullable: false),
                    PlayerB = table.Column<Guid>(type: "TEXT", nullable: false),
